...
- The WoF shows that the vehicle was roadworthy when inspected. It's the driver's responsibility to ensure that the vehicle is maintained and is roadworthy all the time. 
- The WoF label shows the expiry month and that it was inspected.

WOF贴在右上角

You can drive a moped (50cc or under) on a car licence.
...
When coming to a pedestrian crossing with a raised traffic island in the middle, you only need to stop if the pedestrian is crossing or waiting to cross your side of the crossing.

If the crossing doesn't have a central raised traffic island, then you must stop when the pedestrian is waiting to cross on your side of the road, is crossing your side of the road, or is on the crossing on the other side of the road walking towards your side



A yellow line is painted at a stop sign and a white line is painted at a give way sign
...
You receive 20 demerit points for exceeding the speed limit by 11-20kph.
...
The speed limit from the time you pass an Accident or Crash sign until you have passed the crash site is 20km/h
...
100km/h is the maximum speed you are allowed to drive on the open road in a car or on a motorbike. However, there are two motorway sections where you can drive 110km/h
...
| 中文速记                                                     | en                                                           |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 不需要系安全带的情况:<br />1. 部分倒车<br />2. 出租车司机<br />3. 经常停车，低于50kph<br />4. 佩戴安全带后够不着controller<br />5. 医疗豁免 | A. If you are reversing and wouldn't be able to remain in control of the vehicle<br/>B. If you are a taxi driver plying for hire<br/>C. If you are a driver or passenger who has to stop frequently to, for example, read meters, and the vehicle you're in travels at less than 50km/h<br/>D. If you are unable to reach the controls if you wear a safety belt<br/>E. If you have a medical exemption from wearing a safety bel |
...
| 车辆左转不得左侧超车                                         | If a vehicle is indicating left you must not pass it on the left because there is a risk it will turn into your path.<br />如果车辆向左行驶，您不得从左侧超车，因为它有可能会驶入您的道路。 |
| 倒车 -<br />最好下车走<br />至少看后视镜；look over shoulder<br />不必要下车；开启倒车感应器 | The best way is to walk around the vehicle before reversing 倒车, but you could use all of these. At minimum you will check your mirrors and look over your shoulder. It's not compulsory to get out of your car, or have reversing sensors/camera installed. |
| 看到警车，靠边停车                                           | \- What must you do when you see blue and red flashing lights(警车) behind you? \- Pullover 靠边停车 and stop. 您必须靠边停车并停车，除非警察在您靠边停车并继续前行时超越您。 |
...
\- What must you do before you turn to the right from a straight road? - 1. signal 3 secs; 2. give way to vehicles from straight ahead turning left/going straight on; 3. move towards the center line; 4. check your mirrors
...
| 中文简述                                                     | en                                                           |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 违反限制性驾照条款 - 扣35分，罚100<br />违反其他驾照条款 - 罚25分，罚400 | The penalty for driving outside of the conditions of your restricted licence is 35 demerit points and a $100 fine. Breaching other licence restrictions attracts a $400 fine and 25 demerit points. |
...
| 中文描述                         | en                                                           |
| -------------------------------- | ------------------------------------------------------------ |
| front tyre blowout<br />前轮爆胎 | The front end will pull toward the side of the blow out<br />When the wheel has a blowout it suddenly becomes more difficult for the wheel to rotate and also it is a smaller radius so this makes the car pull in direction of the blowout<br />当车轮爆胎，车轮旋转会变得更困难。爆胎后，车轮的有效半径变小<br />汽车前部会向爆胎的那一侧偏移。 |
| 后轮爆胎                         | The back end is likely to first swing out the same side as the blowout, but will sway from side to side.<br />汽车后部摇摆 |
...
- T字路口竖底让横顶
- 下坡让上坡
- 人行横道 - 中间有岛台，只让自己这一侧；无岛台，让全部; Courtesy crossings，不强制停车



The basic give way rules are:

1. Give way to your **right** at **roundabouts** (and all other situations)

2. Give way to vehicles coming from **straight** ahead if you are **turning right**

3. Give way to vehicles **turning left** if you are **turning right**

4. Give way to all vehicles on the top of a **T-intersection** if you are on the bottom of the T

5. Give way to all vehicles moving **uphill** if you are moving **downhill **

6. When coming to a pedestrian crossing with a **raised traffic island in the middle**, you only need to stop if the pedestrian is crossing or waiting to cross your side of the crossing.
...
The clockwise nature of a roundabout means you give way to vehicles coming from your right. Technically, if someone is using a roundabout incorrectly they might come from your left (and you should avoid hitting them), but this situation would be almost unheard of. It's likely they would be at fault in any incident.

![](C:/Users/%E6%83%A0%E6%99%AE/AppData/Roaming/Typora/typora-user-images/image-20250706230250913.png)

If you are going straight through a roundabout, don't signal as you come up to the roundabout, only signal left as you pass the exit before the one you wish to take.
...
| situation                                                    | distance     | operation                                                    |
| ------------------------------------------------------------ | ------------ | ------------------------------------------------------------ |
| 公交车道上可行使50m                                          | 50m          | You can travel up to 50m to turn into a driveway or side road, or when exiting a driveway or side road to get up to the same speed as traffic |
| 能看清100m可超车                                             | 100m ahead   | You can overtake if you'll be able to see 100m ahead once you've finished passing |
| turn lights on - can't see a person while driving<br />100m开灯 | 100m away    | If you can't see a person 100m away while driving, you should turn your lights on. |
| gap between your vehicle and a cyclist<br />和自行车车距1.5m | 1.5m         | You need to leave at least a 1.5m gap between your vehicle and a cyclist. |
| towing<br />拖车最长4m                                       | up to 4m     | 4m is the maximum distance allowed between the rear 后方 of the vehicle towing 拖车, and the front of the vehicle being towed. |
...
The definition of a road is quite broad. It includes streets, motorways, beaches, a place to which the public have access (whether as of right or not), bridges, culverts (涵洞), ferries, fords that form part of a street or motorway, and all sites where a vehicle may be weighed for the purposes of the Land Transport Act. The definition includes locations where there are access to operations such as distribution centres with fenced forecourts but when the gates are open.
...
| Multi-lane road    | 多车道道路                                                   |
| Bypass             | 绕行道路/外环路，是功能定义，不是按车道数量命名              |
| Quad-lane road     | 四车道道路                                                   |
...
| lights                                          | definition          | note                                                         |
| ----------------------------------------------- | ------------------- | ------------------------------------------------------------ |
| Hazard lights/emergency flashers/warning lights | 危险警示灯 / 双闪灯 |                                                              |
| dipped headlights/low beam                      | 近光灯              | When should you dip your headlights? <br />有车驶来；跟车；停车；警察指挥交通；雾<br />倒车不需要<br />1. another vehicle is coming towards you<br />2. following another vehicle<br />3. parking<br />4. a police officer is directing traffic<br />5. driving in foggy weather<br />× while you are performing a reversing manoeuvre （车辆）驾驶动作 you don't need to dip your headlights |
| high beam/full beam                             | 远光灯              |                                                              |
| Daytime Running Lights/DRL                      | 日间行车灯          | 白天自动亮起，增强车辆在白天的可见度，提高安全               |
| Position lights/park lights                     | 示宽灯， 停车灯     | 在车子停在路边或昏暗环境下，让其他道路使用者看得到你的车     |
| horn                                            | 喇叭                |                                                              |

- If you can't see a person 100 meters away while driving, you need to turn your lights on. 能见度100m 不开灯


- If yellow traffic signals are flashing, it means the traffic signals are faulty. 黄灯闪说明交通灯坏了
...
| ----------- | ------------------------------------------------------------ |
| 20kph       | pass an accident or CRASG sign                               |
| 20kph       | pass the school                                              |
| 80kph       | 节省空间的车轮最高时速 <br />Space saver wheels are not designed for high speeds as they have less grip (and therefore less stopping and cornering ability). 80kph is the maximum speed allowed on a space saver tyre. |
| 90kph       | The maximum speed for a car towing a trailer is 90kph.       |
| 100kph      | 100km/h is the maximum speed you are allowed to drive on the open road in a car or on a motorbike<br />特别路段可以开到110kph |
...
![](https://www.drivingtests.co.nz/media/question-images/marker-post-bridge-right.gif)

the left side of a bridge:

![](https://www.drivingtests.co.nz/media/question-images/marker-post-bridge-left.gif)

the right side of the road:

![](https://www.drivingtests.co.nz/media/question-images/marker-post-right-2.gif)
...
On a Transit Lane sign, T2 means only vehicles carrying two or more ppl can use this lane

derestriction sign, meaning the open road speed limit is valid.

![](https://www.drivingtests.co.nz/media/question-images/open-road-speed-limit.png)

keep left (i.e. drive around the roundabout clockwise)
...
the loading zone is for commercial vehicles only:

![](C:/Users/%E6%83%A0%E6%99%AE/AppData/Roaming/Typora/typora-user-images/image-20250707102545334.png)

You can't park here between 7-9am:

<img src="https://www.drivingtests.co.nz/media/question-images/clearway-sign-7-9.gif" style="zoom:80%;" />
...
红灯消防车 Fire engines and ambulances have red lights.

![](https://www.drivingtests.co.nz/media/question-images/fire-flash-lights.gif)

拖车领航车 pivot vehicle

really large load (greater than 5m wide) -

![](https://www.drivingtests.co.nz/media/question-images/danger-slow-down-sign.gif)

The second pilot and a rear pilot on a load in excess of 5m has yellow and purple lights.

The first pilot vehicle has yellow lights if it's a large load.

If towing a load wider than 5 metres the first pilot vehicle has yellow and purple lights and the second one has yellow lights; if it's a wide load between 2.5-5 metres the lead and following pilot vehicles have yellow flashing lights.

自行车走车道中央 sharrows - they show areas where cyclists may need to move to the centre of the lane because staying left could be dangerous for them. For example, if the road is narrow or when parked car doors might unexpectedly open in their path.

![](https://www.drivingtests.co.nz/media/question-images/sharrow-marking.jpg)

**Warning signs - orange and yellow**

路面颠簸 - 减速路障 'traffic calming measures', 'sleeping policemen' or 'judder bars'.

<img src="https://www.drivingtests.co.nz/media/question-images/road-bump-ahead-sign.gif" style="zoom:50%;" />

路面不平坦 uneven road surface ahead

<img src="https://www.drivingtests.co.nz/media/question-images/uneven-road-surface-sign.gif" style="zoom:50%;" />

轻轨路口 light rail crossing ahead

<img src="https://www.drivingtests.co.nz/media/question-images/light-rail-crossing.JPG" style="zoom:80%;" />

指挥交通 roadworks where a road worker will direct traffic usually with a stop/go sign

<img src="https://www.drivingtests.co.nz/media/question-images/stop-on-request.gif" style="zoom: 43%;" />

avoid throwing up loose chippings/loose stone- drive slowly

<img src="https://www.drivingtests.co.nz/media/question-images/gravel-road-surface.gif" style="zoom:65%;" />

a breakdown or crash ahead

![](https://www.drivingtests.co.nz/media/question-images/warning-triangle.jpg)

temporary speed limit

![](https://www.drivingtests.co.nz/media/question-images/temporary-sign.JPG)

巴士，自行车，摩托车道 If there are no other signs indicating that it's bus only, then cyclists, motorbikes and moped riders can also use it.

![](https://www.drivingtests.co.nz/media/question-images/bus-lane.JPG)
...
- You can stop or park your vehicle over a **fire hydrant** if someone stays with the vehicle who can move it

- You're not allowed to park on a **broken yellow line**

- What should you do when parking your vehicle next to the kerb when **facing down a steep hill**? 

  Turning the wheels **towards the kerb** means if the handbrake/parking brake fails the car will come to rest against the kerb and won't roll any further. 

  Putting it in **reverse gear** will provide a lot of engine braking.

- If someone can move the vehicle immediately you may park on or closer than 50cm to a fire hydrant.
...
| where                                                        | minimum distance / (metres) |
| ------------------------------------------------------------ | --------------------------- |
| approach side of a crossing (if there are no broken yellow lines) | 6                           |
| intersection (unless there are parking bays marked)          | 6                           |
| vehicle entrance                                             | 1                           |
...
- 指用手不停地摸、转、摆弄某样东西，尤其是在紧张、无聊或分心时
- fiddle with（摆弄）手机、收音机、导航、空调等

oversteer*

- 转向过度

- 在驾驶里，指车辆在转弯时，后轮抓地力不足，车尾开始滑出去，导致车子转弯角度比你打的方向盘角度更大。

deviate

- 偏离，deviate from the centre line

hold the emergency vehicle up

- hold … up: 阻挡、耽误，to delay or block someone/something
- emergency vehicle: 紧急车辆，比如救护车 (ambulance)、消防车 (fire engine)、警车 (police car) 等

pull over

- 把车驶向路边停下（to steer the vehicle to the side of the road and stop）
...
- 扣押、拖吊。在交通里，通常是指警察或交通执法人员 把你的车拖走并暂时保管起来，因为你违反了法律或规定

strand

- 滞留
- The flood stranded the drivers.
- You must check there's enough room to get your vehicle across or you may be stranded on the lines when a train is coming.

- be held out 放下
- be pulled back in 抬起
...
- N 型掉头（多点掉头 / 三点掉头）指的是因为道路太窄，不能一次性掉头，需要分成几个步骤（一般是三步）。动作形状像字母 N。
...
**manoeuvre**，在驾驶里，通常指驾驶员为了改变车的位置或方向而做出的 **驾驶动作**，比如：
